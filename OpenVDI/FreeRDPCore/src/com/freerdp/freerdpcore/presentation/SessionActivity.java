			   ...
			   ClipboardManagerProxy.OnClipboardChangedListener
{
	...
	private final boolean autoScrollTouchPointer = GlobalSettings.getAutoScrollTouchPointer();
	...
	private Point mapScreenCoordToSessionCoord(int x, int y) {
		int mappedX = (int)((x + scrollView.getScrollX()) / sessionView.getZoom());
		int mappedY = (int)((y + scrollView.getScrollY()) / sessionView.getZoom());
